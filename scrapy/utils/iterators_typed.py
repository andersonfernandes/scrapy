...
from typing import Iterator, Optional, Dict, Any, List, Iterable, Union
...
def xmliter(obj: Optional[Response], nodename: str) -> Iterator[Selector]:
...
def xmliter_lxml(
    obj: Optional[Response], nodename: str, namespace: Optional[str] = None, prefix: str = "x"
) -> Iterator[Selector]:
...
class _StreamReader:
    def __init__(self, obj: Optional[Response]) -> None:
        self._ptr = 0
    ...
    def read(self, n: int = 65535) -> str:
        self.read = self._read_unicode if self._is_unicode else self._read_string
        return self.read(n).lstrip()

    def _read_string(self, n: int = 65535) -> str:
...
def csviter(
    ...
    def row_to_unicode(row_: List[str]) -> List[str]:
...
def _body_or_str(obj: Union[Response, str, bytes], unicode: bool = True) -> str:
