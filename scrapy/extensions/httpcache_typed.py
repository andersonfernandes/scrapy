...
class DummyPolicy:
    ...
    def is_cached_response_valid(self, cachedresponse: Response, response: Response, request: Request):
        return True
...
class RFC2616Policy:
    ...
    def _parse_cachecontrol(self, r: Union[Request, Response]):
    ...
    def _set_conditional_validators(self, request: Request, cachedresponse: Response):
    ...
    def _compute_freshness_lifetime(self, response: Response, request: Request, now) -> int:
    ...
    def _compute_current_age(self, response: Response, request: Request, now) -> int:
...
def parse_cachecontrol(header: str) -> Dict[str, Optional[str]]:
