...
class CookieJar:
    ...
    def extract_cookies(self, response: Response, request: Request) -> Cookie:
        wreq = WrappedRequest(request)
        wrsp = WrappedResponse(response)
        return self.jar.extract_cookies(wrsp, wreq)

    def add_cookie_header(self, request: Request):
        wreq = WrappedRequest(request)
    ...
    def clear(self, domain: Optional[str] = None, path: Optional[str] = None, name: Optional[str] = None):
    ...
    def make_cookies(self, response: Response, request: Request):
        wreq = WrappedRequest(request)
        wrsp = WrappedResponse(response)
    ...
    def set_cookie_if_ok(self, cookie: Cookie, request: Request):
        self.jar.set_cookie_if_ok(cookie, WrappedRequest(request))


def potential_domain_matches(domain: str) -> list:
...
class WrappedRequest:
    ...
    def get_header(self, name: str, default: Optional[str] =None):
...
class WrappedResponse:
    ...
    def get_all(self, name: str, default: Optional[str] =None):
        return [
